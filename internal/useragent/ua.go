...
import (
	...
	"github.com/corner4world/plugin-gbclient/internal/catalog"
	"github.com/corner4world/plugin-gbclient/internal/conf"
	"github.com/corner4world/plugin-gbclient/internal/invite"
	"github.com/corner4world/plugin-gbclient/internal/reg"
	"github.com/corner4world/plugin-gbclient/internal/transport"
...
func NewService(xlog *xlog.Logger, cfg *conf.Config) (*Service, error) {
